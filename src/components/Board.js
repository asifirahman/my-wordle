...
function Board() {
  return (
       <div className="board">
        ...
        <div className="row">
          <Letter letterPosition="0" attemptValue="6" />
          <Letter letterPosition="1" attemptValue="6" />
          <Letter letterPosition="2" attemptValue="6" />
          <Letter letterPosition="3" attemptValue="6" />
          <Letter letterPosition="4" attemptValue="6" />
          <Letter letterPosition="5" attemptValue="6" />
        </div>
        <div className="row">
          <Letter letterPosition="0" attemptValue="7" />
          <Letter letterPosition="1" attemptValue="7" />
          <Letter letterPosition="2" attemptValue="7" />
          <Letter letterPosition="3" attemptValue="7" />
          <Letter letterPosition="4" attemptValue="7" />
          <Letter letterPosition="5" attemptValue="7" />
        </div>
      </div>
  )
}
